# salloc -N 1 -C cpu -t 04:00:00 -q interactive python desi_per_fiber_qa_plots.py -v kibo -o /pscratch/sd/r/rongpu/tmp --tracer LRG --stats /pscratch/sd/r/rongpu/tmp/per_fiber_qa_stats.fits
# salloc -N 1 -C cpu -t 04:00:00 -q interactive python desi_per_fiber_qa_plots.py -v kibo -o /pscratch/sd/r/rongpu/tmp --tracer ELG_LOP --stats /pscratch/sd/r/rongpu/tmp/per_fiber_qa_stats.fits
# salloc -N 1 -C cpu -t 04:00:00 -q interactive python desi_per_fiber_qa_plots.py -v kibo -o /pscratch/sd/r/rongpu/tmp --tracer ELG_VLO --stats /pscratch/sd/r/rongpu/tmp/per_fiber_qa_stats.fits
# salloc -N 1 -C cpu -t 04:00:00 -q interactive python desi_per_fiber_qa_plots.py -v kibo -o /pscratch/sd/r/rongpu/tmp --tracer QSO --stats /pscratch/sd/r/rongpu/tmp/per_fiber_qa_stats.fits
# salloc -N 1 -C cpu -t 04:00:00 -q interactive python desi_per_fiber_qa_plots.py -v kibo -o /pscratch/sd/r/rongpu/tmp --tracer BGS_BRIGHT --stats /pscratch/sd/r/rongpu/tmp/per_fiber_qa_stats.fits
# salloc -N 1 -C cpu -t 04:00:00 -q interactive python desi_per_fiber_qa_plots.py -v kibo -o /pscratch/sd/r/rongpu/tmp --tracer BGS_FAINT --stats /pscratch/sd/r/rongpu/tmp/per_fiber_qa_stats.fits
    ...
    if save_png:
        ...
        for fiber in range(5000):
            ...
            if np.sum(mask)==0:
                ...
                ax.set_xlim(datemin, datemax)
                plt.tight_layout()
                plt.savefig(os.path.join(png_dir, 'FIBER_{}'.format(fiber)))
                plt.close()
