...
# Examples:
# python desi_per_fiber_variations.py -t LRG -v iron -o /global/cfs/cdirs/desi/users/rongpu/redshift_qa/per_fiber_qa/iron
# python desi_per_fiber_variations.py -t BGS_ANY -v iron -o /global/cfs/cdirs/desi/users/rongpu/redshift_qa/per_fiber_qa/iron
